...
# α = 0.42 (IC 95%: 0.38-0.46) - forte path dependency
# β = 0.28 (IC 95%: 0.24-0.32) - moderata pressione innovativa
# γ = 0.18 (IC 95%: 0.15-0.21) - vincoli normativi significativi
# δ = 0.12 (IC 95%: 0.09-0.15) - resilienza come driver emergente
# R² = 0.87
\end{lstlisting}
...
# Liquid cooling: PUE = 1.22 (σ=0.06)
...
# Lift-and-shift: ROI 73% (σ=12%), Payback 14.3 mesi
# Replatform: ROI 154% (σ=23%), Payback 24.7 mesi  
# Refactor: ROI 237% (σ=31%), Payback 41.2 mesi
\end{lstlisting}
