...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{thesis_figures/fig_1_1_gist_framework.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{thesis_figures/fig_1_4_thesis_structure.pdf}
