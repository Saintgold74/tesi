...
L'analisi statistica condotta su 1.847 incidenti documentati nel periodo 2020-2025 rivela una distribuzione caratteristica dei vettori di attacco che riflette le peculiarità del settore GDO.

% \begin{figure}[htbp]
% \centering
% \includegraphics[width=0.9\textwidth]{placeholder_attack_vectors}
% \caption{Distribuzione dei vettori di attacco primari nel settore GDO (2020-2025). L'analisi evidenzia la prevalenza di attacchi mirati ai sistemi di pagamento e la crescente sofisticazione delle tecniche di compromissione.}
...
L'analisi quantitativa fornisce evidenze robuste sull'efficacia delle contromisure proposte, con risultati statisticamente significativi che supportano le ipotesi di ricerca.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{placeholder_security_framework}
\caption{Framework Integrato di Sicurezza GDO - Dal Threat Landscape all'Architettura. Il framework mostra l'interconnessione tra analisi delle minacce, principi Zero Trust e decisioni architetturali.}
