\chapter{\texorpdfstring{Threat Landscape e Sicurezza Distribuita}{Capitolo 2 - Threat Landscape e Sicurezza Distribuita}}\label{capitolo-2---threat-landscape-e-sicurezza-distribuita-nella-gdo}
...
\section{\texorpdfstring{Caratterizzazione della Superficie di Attacco nella GDO}{Caratterizzazione della Superficie di Attacco nella GDO}}\label{caratterizzazione-della-superficie-di-attacco-nella-gdo}

\subsection{\texorpdfstring{Modellazione Matematica della Vulnerabilità Distribuita}{Modellazione Matematica della Vulnerabilità Distribuita}}\label{modellazione-matematica-della-vulnerabilituxe0-distribuita}
...
\subsection{\texorpdfstring{Analisi dei Fattori di Vulnerabilità Specifici}{Analisi dei Fattori di Vulnerabilità Specifici}}\label{analisi-dei-fattori-di-vulnerabilituxe0-specifici}
...
\subsection{\texorpdfstring{Il Fattore Umano come Moltiplicatore di Rischio}{Il Fattore Umano come Moltiplicatore di Rischio}}\label{il-fattore-umano-come-moltiplicatore-di-rischio}
...
\section{\texorpdfstring{Anatomia degli Attacchi: Analisi Tecnica e Pattern Evolutivi}{Anatomia degli Attacchi: Analisi Tecnica e Pattern Evolutivi}}\label{anatomia-degli-attacchi-analisi-tecnica-e-pattern-evolutivi}
...
Il malware conosciuto col nome di \textbf{Prilex}\supercite{kaspersky2024prilex} rappresenta un esempio paradigmatico di questa
